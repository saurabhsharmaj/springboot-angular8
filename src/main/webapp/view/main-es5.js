...
/***/ "./node_modules/raw-loader/index.js!./src/app/cpu-line-chart/cpu-line-chart.component.html":
/*!****************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/cpu-line-chart/cpu-line-chart.component.html ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ "./node_modules/raw-loader/index.js!./src/app/memory-chart/memory-chart.component.html":
/*!************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/memory-chart/memory-chart.component.html ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<p>memory-chart works!</p>\n<rg-gauge-chart\n    [canvasWidth]=\"canvasWidth\"\n    [needleValue]=\"needleValue\"\n    [centralLabel]=\"centralLabel\"\n    [options]=\"options\"\n    [name]=\"name\"\n    [bottomLabel]=\"bottomLabel\"></rg-gauge-chart>"

/***/ }),

/***/ "./node_modules/raw-loader/index.js!./src/app/storage-chart/storage-chart.component.html":
/*!**************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/storage-chart/storage-chart.component.html ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<p>storage-chart works!</p>\n<google-chart #chart  \n   [title]=\"title\"  \n   [type]=\"type\"  \n   [data]=\"data\"  \n   [columnNames]=\"columnNames\"  \n   [options]=\"options\"  \n   [width]=\"width\"  \n   [height]=\"height\">  \n</google-chart> "
...
/* harmony import */ var _cpu_line_chart_cpu_line_chart_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./cpu-line-chart/cpu-line-chart.component */ "./src/app/cpu-line-chart/cpu-line-chart.component.ts");
/* harmony import */ var _memory_chart_memory_chart_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./memory-chart/memory-chart.component */ "./src/app/memory-chart/memory-chart.component.ts");
/* harmony import */ var _storage_chart_storage_chart_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./storage-chart/storage-chart.component */ "./src/app/storage-chart/storage-chart.component.ts");
...
var routes = [
    ...
    { path: 'cpu', component: _cpu_line_chart_cpu_line_chart_component__WEBPACK_IMPORTED_MODULE_7__["CpuLineChartComponent"] },
    { path: 'memory', component: _memory_chart_memory_chart_component__WEBPACK_IMPORTED_MODULE_8__["MemoryChartComponent"] },
    { path: 'storage', component: _storage_chart_storage_chart_component__WEBPACK_IMPORTED_MODULE_9__["StorageChartComponent"] },
...
/* harmony import */ var _cpu_line_chart_cpu_line_chart_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./cpu-line-chart/cpu-line-chart.component */ "./src/app/cpu-line-chart/cpu-line-chart.component.ts");
...
/* harmony import */ var angular_gauge_chart__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! angular-gauge-chart */ "./node_modules/angular-gauge-chart/fesm5/angular-gauge-chart.js");
/* harmony import */ var _memory_chart_memory_chart_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./memory-chart/memory-chart.component */ "./src/app/memory-chart/memory-chart.component.ts");
/* harmony import */ var _storage_chart_storage_chart_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./storage-chart/storage-chart.component */ "./src/app/storage-chart/storage-chart.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _cpu_line_chart_cpu_line_chart_component__WEBPACK_IMPORTED_MODULE_12__["CpuLineChartComponent"],
                _memory_chart_memory_chart_component__WEBPACK_IMPORTED_MODULE_16__["MemoryChartComponent"],
                _storage_chart_storage_chart_component__WEBPACK_IMPORTED_MODULE_17__["StorageChartComponent"]
            ],
            imports: [
                ...
                angular_gauge_chart__WEBPACK_IMPORTED_MODULE_15__["GaugeChartModule"],
...
/***/ "./src/app/cpu-line-chart/cpu-line-chart.component.css":
/*!*************************************************************!*\
  !*** ./src/app/cpu-line-chart/cpu-line-chart.component.css ***!
  \*************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NwdS1saW5lLWNoYXJ0L2NwdS1saW5lLWNoYXJ0LmNvbXBvbmVudC5jc3MifQ== */"

/***/ }),

/***/ "./src/app/cpu-line-chart/cpu-line-chart.component.ts":
/*!************************************************************!*\
  !*** ./src/app/cpu-line-chart/cpu-line-chart.component.ts ***!
  \************************************************************/
/*! exports provided: CpuLineChartComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var CpuLineChartComponent = /** @class */ (function () {
    function CpuLineChartComponent(route, router, imconfigService) {
        this.route = route;
        this.router = router;
    ...
    CpuLineChartComponent.prototype.ngOnInit = function () {
        var _this = this;
        Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["timer"])(0, 5000).pipe().subscribe(function (data) {
            _this.reloadData();
        });
    };
    CpuLineChartComponent.prototype.reloadData = function () {
        var _this = this;
        this.imconfigService.getCPUValue().subscribe(function (data) {
            console.log(data);
            _this.needleValue = data;
            _this.bottomLabel = data;
            _this.options.arcDelimiters = [data];
            _this.options.needleStartValue = data;
        }, function (error) { return console.log(error); });
    };
    CpuLineChartComponent.ctorParameters = function () { return [
    ...
    CpuLineChartComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./cpu-line-chart.component.html */ "./node_modules/raw-loader/index.js!./src/app/cpu-line-chart/cpu-line-chart.component.html"),
            styles: [__webpack_require__(/*! ./cpu-line-chart.component.css */ "./src/app/cpu-line-chart/cpu-line-chart.component.css")]
        })
    ], CpuLineChartComponent);
    return CpuLineChartComponent;
}());
...
/***/ "./src/app/memory-chart/memory-chart.component.css":
/*!*********************************************************!*\
  !*** ./src/app/memory-chart/memory-chart.component.css ***!
  \*********************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21lbW9yeS1jaGFydC9tZW1vcnktY2hhcnQuY29tcG9uZW50LmNzcyJ9 */"

/***/ }),

/***/ "./src/app/memory-chart/memory-chart.component.ts":
/*!********************************************************!*\
  !*** ./src/app/memory-chart/memory-chart.component.ts ***!
  \********************************************************/
/*! exports provided: MemoryChartComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MemoryChartComponent", function() { return MemoryChartComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");


var MemoryChartComponent = /** @class */ (function () {
    function MemoryChartComponent() {
        this.canvasWidth = 300;
        this.needleValue = 65;
        this.centralLabel = '';
    ...
    MemoryChartComponent.prototype.ngOnInit = function () {
    };
    MemoryChartComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-memory-chart',
            template: __webpack_require__(/*! raw-loader!./memory-chart.component.html */ "./node_modules/raw-loader/index.js!./src/app/memory-chart/memory-chart.component.html"),
            styles: [__webpack_require__(/*! ./memory-chart.component.css */ "./src/app/memory-chart/memory-chart.component.css")]
        })
    ], MemoryChartComponent);
    return MemoryChartComponent;
}());
...
/***/ "./src/app/storage-chart/storage-chart.component.css":
/*!***********************************************************!*\
  !*** ./src/app/storage-chart/storage-chart.component.css ***!
  \***********************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3N0b3JhZ2UtY2hhcnQvc3RvcmFnZS1jaGFydC5jb21wb25lbnQuY3NzIn0= */"

/***/ }),

/***/ "./src/app/storage-chart/storage-chart.component.ts":
/*!**********************************************************!*\
  !*** ./src/app/storage-chart/storage-chart.component.ts ***!
  \**********************************************************/
/*! exports provided: StorageChartComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StorageChartComponent", function() { return StorageChartComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");


var StorageChartComponent = /** @class */ (function () {
    function StorageChartComponent() {
        this.title = 'Company Hiring Report';
    ...
    StorageChartComponent.prototype.ngOnInit = function () {
    };
    StorageChartComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-storage-chart',
            template: __webpack_require__(/*! raw-loader!./storage-chart.component.html */ "./node_modules/raw-loader/index.js!./src/app/storage-chart/storage-chart.component.html"),
            styles: [__webpack_require__(/*! ./storage-chart.component.css */ "./src/app/storage-chart/storage-chart.component.css")]
        })
    ], StorageChartComponent);
    return StorageChartComponent;
}());
